	...
	<div class="row">
		...
		<div class="col-sm-6">
			<p class="text-center"><a href="<?php echo $siteData['url']?>/input" class="btn btn-lg btn-primary">Поступление</a></p>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-6">
			<p class="text-center"><a href="<?php echo $siteData['url']?>/clients" class="btn btn-lg btn-success">Клиенты</a></p>
		</div>
		<div class="col-sm-6">
			<p class="text-center"><a href="<?php echo $siteData['url']?>/medicine" class="btn btn-lg btn-success">Лекарства</a></p>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-6">
